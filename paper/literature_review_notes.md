...
| `khalid_2022_fakeavceleb`            | FakeAVCeleb: A Novel Audio-Video Multimodal Deepfake Dataset                                                               | 2022 | Dataset / Audio-Visual Benchmark  | Assess FakeAVCeleb as the likely main paired audio-video dataset for the project.                           | Not Read |
...
| `cai_2023_avdeepfake1m`              | AV-Deepfake1M: A Large-Scale LLM-Driven Audio-Visual Deepfake Dataset                                                      | 2023 | Dataset / Audio-Visual Benchmark  | Understand a newer large-scale audio-visual deepfake dataset beyond FakeAVCeleb.                            | Not Read |
